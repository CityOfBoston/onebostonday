$(function() {
    ...
    if (body.addClass("ready"), $(".intro button.watch-video").on("click", function(event) {
        ...
        Modernizr.touchevents ? window.location.href = "https://www.youtube.com/watch?v=xyRRDSNnIVk" : ($(".intro").prepend('<div class="video-player"><iframe src="https://www.youtube.com/embed/' + videoId + '?autoplay=true" frameborder="0" allowfullscreen></iframe></div>'), 
