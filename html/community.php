...
<?php include 'includes/navigation.php' ?>
    <section class="header-intro">
        ...
        <p>One Boston Day is an opportunity for businesses and organizations to display their humanity and bring neighbors together. Here are a few ways the Boston business and non-profit community got involved in 2015:</p>
    </section>
    ...
    <section class="planning" id="planning">
        <div class="block">
            <header class="section-intro">
                <h2>We encourage you to share how your organization is participating in One Boston Day.</h2>
                ...
                <fieldset>
                    ...
                    <div class="select-wrapper">
                        <select name="entry.1208203883">
                            ...
                            <option value="Medium" selected>Medium (50-100 People)</option>
